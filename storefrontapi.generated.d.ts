...
export type DemoProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle'
> & {
  priceRange: {
...
export type DemoProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
> & {
  images: {
    edges: Array<
      Pick<StorefrontAPI.ImageEdge, 'cursor'> & {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment DemoProduct on Product {\n    id\n    title\n    handle\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    images(first: 1) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n  }\n  query DemoProducts ($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 4, sortKey: UPDATED_AT, reverse: true) {\n      nodes {\n        ...DemoProduct\n      }\n    }\n  }\n': {
    return: DemoProductsQuery;
    variables: DemoProductsQueryVariables;
  };
